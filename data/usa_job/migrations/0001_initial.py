# Generated by Django 3.2.5 on 2021-11-22 06:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grades', models.ManyToManyField(related_name='usajob_relations', to='job_grade.JobGrade')),
                ('offering_types', models.ManyToManyField(related_name='usajob_relations', to='job_offering_type.JobOfferingType')),
                ('remunerations', models.ManyToManyField(related_name='usajob_relations', to='job_remuneration.JobRemuneration')),
                ('schedules', models.ManyToManyField(related_name='usajob_relations', to='job_schedule.JobSchedule')),
            ],
            options={
